...
const Sidebar = () => {
	const [randomNmuber, setRandomNumber] = useState(
			...
			<Card className='sidebar__top'>
				...
				<div className='sidebar__starts'>
					<div className='sidebar__star'>
						...
						<p className='sidebar__starNumber'>{randomNmuber * 3}</p>
					</div>
					<div className='sidebar__star'>
						<p>views of your post</p>
						<p className='sidebar__starNumber'>{randomNmuber + 10}</p>
					</div>

					<div className='sidebar__star'>
						<p>views of your video</p>
						<p className='sidebar__starNumber'>{randomNmuber + 5}</p>
					</div>
				</div>
